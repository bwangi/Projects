...
/**
 * Some comprehensive tests for node and binary search tree. Please don't just
 * rely on these tests, because I may have missed some special cases Also, lemme
 * know on Blackboard if I missed any special cases, or if there are any issues
 * with the tests.
 * 
 * @author Peter Keppeler
 *
 */
public class NodeAndBinarySearchTreeTests {
	...
	public void testConstructor2() {
		...
		assertEquals(tree1.getInorderTravseral(), temp.getInorderTravseral());
	}
	...
	public void testAdd2() {
		...
		assertEquals(res, tree1.getInorderTravseral());
	}
	...
	// testing getPredecessor for a node at beginning of InOrderTraverse should
	// return null
	@Test
	...
	// testing getSuccessor for a node at end of InOrderTraverse should return
	// null
	@Test
